 ...
 *
 */
class AclFront extends Component
{
	...
	private $_privateResources = array(
		'users' => array('index', 'search', 'edit', 'create', 'delete', 'changePassword','deleteMuti','transfer'),
		'profiles' => array('index', 'search', 'edit', 'create', 'delete'),
		'permissions' => array('index'),
		'hososinhvien'=> array('index','edit','create','delete','show','update','import')	
	);
