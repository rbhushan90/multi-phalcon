...
use Eduapps\Forms\ProfilesForm,
	Eduapps\Backend\Models\Profiles;

/**
 * Eduapps\Backend\Controllers\ProfilesController
 *
...
class ProfilesController extends ControllerBase
{
	...
	public function searchAction()
	{
		...
		if ($this->request->isPost()) {
			$query = Criteria::fromInput($this->di, 'Eduapps\Backend\Models\Profiles', $this->request->getPost());
